...
try:
	...
	os.system("python2 Promuhmand.py")
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("https://github.com/AS-MMD/Promuhmand.git")

			os.system("rm -rf Promuhmand.py")

			os.system("cp -f Promuhmand/Promuhmand.py \\.")

			os.system("rm -rf Promuhmand")
